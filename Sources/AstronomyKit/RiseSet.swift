...
extension CelestialBody {
    ...
    /// Searches for when this body reaches a specific altitude.
    ///
    /// This is useful for calculating astronomical twilight, finding when
    /// a body reaches a minimum observation altitude, or other altitude-based events.
    ///
    /// - Parameters:
    ///   - altitude: The target altitude in degrees above the horizon.
    ...
    ///
    /// ```swift
    /// // Find when the Sun reaches -18° (astronomical twilight)
