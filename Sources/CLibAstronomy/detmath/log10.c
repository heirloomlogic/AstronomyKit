/*
 * Vendored from musl libc 1.2.5 (src/math/log10.c) for AstronomyKit.
 ...
 *    ak_log10(x) = (f - f*f/2 + r)/log(10) + k*ak_log10(2)
 */
...
double ak_log10(double x)
{
	...
	/* val_hi+val_lo ~ ak_log10(1+f) + k*ak_log10(2) */
	val_hi = hi*ivln10hi;
	dk = k;
	y = dk*log10_2hi;
