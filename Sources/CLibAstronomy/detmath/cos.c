/*
 * Vendored from musl libc 1.2.5 (src/math/cos.c) for AstronomyKit.
 ...
 *      ak___cos           ... cosine function on [-pi/4,pi/4]
...
double ak_cos(double x)
{
	...
	n = ak___rem_pio2(x, y);
	switch (n&3) {
	case 0: return  ak___cos(y[0], y[1]);
	case 1: return -ak___sin(y[0], y[1], 1);
	case 2: return -ak___cos(y[0], y[1]);
	default:
		return  ak___sin(y[0], y[1], 1);
	}
}
