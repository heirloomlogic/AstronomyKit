/*
 * Vendored from musl libc 1.2.5 (src/math/__rem_pio2_large.c) for AstronomyKit.
 ...
 */
/*
 * ak___rem_pio2_large(x,y,e0,nx,prec)
 * double x[],y[]; int e0,nx,prec;
 *
 * ak___rem_pio2_large return the last three digits of N with
 *              y = x - N*pi/2
 * so that |y| < pi/2.
 *
...
int ak___rem_pio2_large(double *x, double *y, int e0, int nx, int prec)
{
...
recompute:
	...
	/* compute n */
	z  = ak_scalbn(z,q0);       /* actual value of z */
